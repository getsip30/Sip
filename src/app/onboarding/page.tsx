...
export default function Onboarding() {
  ...
  if (!isLoaded || checking) return (
    <div style={{ background: '#0A0E16', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <motion.div animate={{ opacity: [0.4, 1, 0.4] }} transition={{ duration: 1.5, repeat: Infinity }} style={{ color: '#8A93A3' }}>loading...</motion.div>
    </div>
  );
  if (step === 'topics') {
    return (
      <div style={{ background: '#0A0E16', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: '#EDEFF3', fontFamily: 'Space Grotesk, sans-serif', padding: 24 }}>
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} style={{ textAlign: 'center', maxWidth: 480, width: '100%' }}>
          ...
          <div style={{ textAlign: 'left', marginBottom: 20 }}>
            ...
            <input type="number" value={age} onChange={e => setAge(e.target.value)} placeholder="e.g. 21"
              style={{ width: '100%', background: '#121923', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 10, padding: '12px 16px', color: '#EDEFF3', fontSize: 15, outline: 'none', boxSizing: 'border-box', fontFamily: 'inherit' }} />
          </div>

          <div style={{ textAlign: 'left', marginBottom: 28 }}>
            <label style={{ fontSize: 13, color: '#8A93A3', display: 'block', marginBottom: 6 }}>LinkedIn profile</label>
          ...
          <p style={{ color: '#8A93A3', fontSize: 14, marginBottom: 14, textAlign: 'left' }}>What are you into? (pick one)</p>
          ...
          <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.97 }} onClick={handleFinishOnboarding} disabled={submitting}
            style={{ width: '100%', background: '#3B82F6', color: 'white', border: 'none', padding: '14px', borderRadius: 12, fontSize: 15, fontWeight: 600, cursor: submitting ? 'not-allowed' : 'pointer', fontFamily: 'inherit' }}>
  ...
  return (
    <div style={{ background: '#0A0E16', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: '#EDEFF3', fontFamily: 'Space Grotesk, sans-serif', padding: 24 }}>
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} style={{ textAlign: 'center', maxWidth: 560 }}>
        ...
        <p style={{ color: '#8A93A3', fontSize: 16, lineHeight: 1.7, marginBottom: 48 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 16 }}>
          <motion.button
            ...
            style={{ background: '#121923', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 20, padding: '36px 24px', cursor: 'pointer', fontFamily: 'inherit', textAlign: 'left', transition: 'all 0.2s' }}>
            <div style={{ fontSize: 18, fontWeight: 700, color: '#EDEFF3', marginBottom: 8 }}>I&apos;m a Mentor</div>
            <div style={{ fontSize: 14, color: '#8A93A3', lineHeight: 1.6 }}>I want to open my door and help people by sharing what I know.</div>
          </motion.button>
          ...
          <motion.button
            ...
            style={{ background: '#121923', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 20, padding: '36px 24px', cursor: 'pointer', fontFamily: 'inherit', textAlign: 'left', transition: 'all 0.2s' }}>
            <div style={{ fontSize: 18, fontWeight: 700, color: '#EDEFF3', marginBottom: 8 }}>I&apos;m Looking for a Sip</div>
            <div style={{ fontSize: 14, color: '#8A93A3', lineHeight: 1.6 }}>I want to find someone to talk to and learn from their experience.</div>
          </motion.button>
        </div>
      </motion.div>
    </div>
