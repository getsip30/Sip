    ...
    <div style={{ background: BG, minHeight: '100vh', color: TEXT, fontFamily: "'Space Grotesk', sans-serif", padding: '80px 40px' }}>
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} style={{ maxWidth: 640, margin: '0 auto' }}>
        ...
        <div style={{ color: MUTED, fontSize: 15, lineHeight: 1.8, display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <p><strong style={{ color: TEXT }}>What we collect:</strong> your name, email, and profile info you provide (bio, topics, availability, age, interests, LinkedIn if you choose to share it). We also log session activity — who joined which room, when, questions and answers exchanged, sip notes, and any reports filed — for safety, moderation, and to run the core product.</p>
          ...
          <p><strong style={{ color: TEXT }}>Security:</strong> we use industry-standard measures — encrypted connections, access controls, and monitoring — to protect your data. No system is perfectly secure, but we take this seriously.</p>
